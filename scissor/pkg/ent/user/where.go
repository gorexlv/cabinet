...
func WxOpenID(v string) predicate.User {
	return predicate.User(sql.FieldEQ(FieldWxOpenID, v))
}
...
func WxOpenIDContainsFold(v string) predicate.User {
	return predicate.User(sql.FieldContainsFold(FieldWxOpenID, v))
}
